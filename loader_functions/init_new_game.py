...
def get_constants():
    ...
    colors = {
        'dark_wall': (30, 40, 40),
        'dark_ground': (10, 10, 10),
        'light_wall': (90, 110, 110),
        'light_ground': (40, 50, 50),
        'light_ground_dot': (50, 60, 60),
...
def get_game_variables(constants):
    ...
    player = Entity(0, 0, '@', constants['colors'].get('black'), 'Player', blocks=True,
     render_order=RenderOrder.ACTOR, fighter=fighter_component, inventory=inventory_component, level=level_component, equipment=equipment_component)
    entities = [player]
